      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-20 lg:grid-cols-12 lg:px-8 lg:py-28">
        ...
        <div className="flex flex-col justify-center lg:col-span-6">
          ...
          <h1 className="text-4xl font-bold leading-[1.05] tracking-tight text-neutral-900 sm:text-5xl lg:text-6xl">
            Every seller.
            <br />
            <span className="text-[#FF5A1F]">Every shopper.</span>
            <br />
            One marketplace.
          </h1>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <button
              ...
              className="group inline-flex items-center gap-2 rounded-full bg-neutral-900 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-neutral-800"
            >
              Start selling
              <ArrowUpRight
                size={16}
            ...
            <button
              ...
              className="rounded-full border border-neutral-300 bg-white px-6 py-3.5 text-sm font-semibold text-neutral-800 transition hover:border-neutral-400"
            >
              Explore products
            </button>
          </div>
          ...
          <div className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-4 border-t border-neutral-200 pt-6">
            ...
            <div className="flex items-center gap-1">
              <Star size={16} className="fill-[#FF5A1F] text-[#FF5A1F]" />
        ...
        <div className="relative flex items-center justify-center lg:col-span-6">
          <div className="relative h-[420px] w-full max-w-md">
            {/* large card */}
            <div className="absolute left-0 top-0 h-64 w-56 rotate-[-4deg] rounded-2xl bg-gradient-to-br from-orange-200 to-orange-400 shadow-xl shadow-orange-200/40" />
            {/* medium card */}
            <div className="absolute right-2 top-10 h-48 w-44 rotate-[6deg] rounded-2xl bg-gradient-to-br from-teal-200 to-teal-500 shadow-xl shadow-teal-200/40" />
            {/* small card */}
            <div className="absolute bottom-0 left-16 h-40 w-40 rotate-[3deg] rounded-2xl bg-gradient-to-br from-neutral-200 to-neutral-400 shadow-xl shadow-neutral-300/40" />
