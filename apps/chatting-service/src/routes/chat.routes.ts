//Path: apps/chatting-service/src/routes/chat.routes.ts
import isAuthenticated from "@packages/middleware/isAuthenticated";
import { fetchSellerMessages, fetchMessages, getSellerConversations, getUserConversations, newConversation } from "../controllers/chatting.controller";
